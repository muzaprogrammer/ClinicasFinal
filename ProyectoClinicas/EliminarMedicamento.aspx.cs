...
public partial class EliminarMedicamento : System.Web.UI.Page
{
    ...
    protected void btnEliminar_Click(object sender, EventArgs e)
    {
        ...
        {
            if (Datos.DeleteMedicamento(Convert.ToInt32(medicamentoCodigo.SelectedValue)))
            {
                lblEstado.Text = "Medicamento eliminado con exito";
